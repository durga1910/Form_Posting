                ...
                <div className="flex flex-col justify-center items-center bg-white border-b-2 rounded-md">
                  ...
                  <div className="flex flex-col justify-center items-start gap-8 p-10">
                    <div className="flex flex-col justify-center items-start gap-3 w-full">
                      <label htmlFor="email" className="classic-label">Email</label>
                      <Field
                        type="text"
                        name="email"
                        id="email"
                    ...
                    <div className="flex flex-col justify-center items-start gap-3 w-full">
                      <label htmlFor="password" className="classic-label">Password</label>
                      <Field
                        type="password"
                        name="password"
                        id="password"
                    ...
                    <div className="flex justify-between items-start gap-1 text-blue-darker">
                      ...
                      <Link href="/terms" className="classic-link">
